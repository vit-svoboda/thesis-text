...
HTML5's \texttt{svg} element as such is well supported by modern browsers\cite{}, but there are some difficulties with the implementation details in different browsers. Internet Explorer does not support \texttt{foreignObject} SVG element\cite{ieforeignobject}
