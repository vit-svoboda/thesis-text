...
\section{Update loop}
The update loop of a game engine can be implemented basically in two ways in JavaScript. The straight forward way would be to set timer and in the callback handle the game update. This way is deprecated since the introduction of a \texttt{requestAnimationFrame} function\cite{raf}.
